            ...
            <form  action="{{route('usuarios.store')}}" method="POST">
            	@csrf
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" class="form-control" name="usu_telefono" id="usu_telefono" maxlength="10" placeholder="Escriba su Apellido" required>
                     </div>
                    ...
                    <div class="form-group col-md-8">
                      	...
                      	<input type="text" class="form-control" name="usu_cedula" id="usu_cedula" maxlength="10" placeholder="Escriba su Cedula" required>
                     </div>
