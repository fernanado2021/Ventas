				...
				<form action="{{route('facturas.store')}}" method="POST">
					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<input type="number"  readonly value="{{$fac_iva}}" id="fac_iva" name="fac_iva"   class="form-control">
						</div>
					</div>
		                    ...
		                    @isset($detalle)
			                    @foreach($detalle as $dt)
			                    	<tr>
			                    		...
			                    		<td style="text-align:center; color: white;">{{$dt->fact_vu}}</td>
			                    		<td colspan="" style="text-align:center; color: white;">{{$dt->fact_vt}}</td>
			                    		<td>
